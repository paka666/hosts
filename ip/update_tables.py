...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        write_output_file(
            ...
            "入站威胁拦截列表 (Inbound Threat Blocklist) - 合并的IPv4和IPv6"
        )
        ...
        write_output_file(
            ...
            inbound_ipv4,
            "入站威胁IPv4拦截列表 (Inbound Threat IPv4 Blocklist)"
        )
        ...
        write_output_file(
            ...
            inbound_ipv6,
            "入站威胁IPv6拦截列表 (Inbound Threat IPv6 Blocklist)"
        )
        ...
        write_output_file(
            ...
            "出站威胁拦截列表 (Outbound Threat Blocklist) - 合并的IPv4和IPv6"
        )
        ...
        write_output_file(
            ...
            outbound_ipv4,
            "出站威胁IPv4拦截列表 (Outbound Threat IPv4 Blocklist)"
        )
        ...
        write_output_file(
            ...
            outbound_ipv6,
            "出站威胁IPv6拦截列表 (Outbound Threat IPv6 Blocklist)"
        )
